...
$('#frmstackholder').on('submit', function(e){ 
        ...
        $.ajax({
            ...
            beforeSend: function(){
                $('#shimag').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');				
            },
	...
	$('#frmteaminfo').on('submit', function(e){
		...
		//}else{ 
			...
			$.ajax({
				...
				beforeSend: function(){
					$('#teamresult').show();
					$('#teamresult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');				
				},
				success: function(data){
			...
			if (r == true) {
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#teamMemAddedID').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');
					},
					success: function(data) {
	...
	$('#frm_milestone').on('submit', function(e){
        ...
        $.ajax({
            ...
            beforeSend: function(){ 
                ...
                $('#milestoneresult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');				
            },
            success: function(data){
	...
	$('#frmproject').on('submit', function(e){
		...
		//}else{ 
			...
			$.ajax({
				...
				beforeSend: function(){
					$('#projectresult').show();
					$('#projectresult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');	 			
				},
				success: function(data){	
		...
		if(fnvalidate_keyDates()==false ){
			...
			$.ajax({
				...
				beforeSend: function(){ 
				    ...
				    $('#keysDataresult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');				
				},
				success: function(data){
					$('#keysDataresult').hide();
					$('#msresultmsg').html('Information Saved');
