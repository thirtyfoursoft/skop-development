...
?>
	...
	<!-- member info section -->
		      ...
		      <div class="form-three-colum">
		        ...
		        <div class="third-colum">
					...
					<input type="hidden" value="<?php echo $memberId;?>" id="memberid<?=$i;?>" name="memberid[]" class="umid" maxlength="100">
						<a style="color: #ff0015 !important;font-size: 18px; font-weight: bold; margin-left: 5px;" class="removeclass" id="removeclassID" onclick="removeteam_members('memberdetails_<?=$i;?>', <?php echo $memberId; ?>); deletenewField();" href="javascript:void(0);">x</a>
		...
		<a class="removeclass" id="removeclassID" onclick="removeteam_members('memberdetails_<?=$i;?>', <?php echo $memberId; ?>); deletenewField();" href="javascript:void(0);">x</a>-->
