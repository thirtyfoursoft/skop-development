<?php 
ob_start(); ini_set('memory_limit','256M');
...
$docxfile = 'Project_details_result'.$userid.'_html.docx';
$filename = $parentpath.'/docx/'.$docxfile;
$downloadPath = $pluginURL.'/docx/'.$docxfile;
$downloadFileName = base64_encode('Charter_Scope.pdf');
...
if(file_exists($filename)){
	...
	$newdocx = new getdocx();
	$template_filename ='Project_details_template';
	$result_filename ='Project_details_result'; 
