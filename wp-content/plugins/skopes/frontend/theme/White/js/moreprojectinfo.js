	...
	if(checkselectioncre()== false){
	   //return false; 
		...
		$.ajax({ 
				...
				beforeSend: function(){
					$('#result').show();
					$('#result').html('<img src="/wp-content/plugins/skopes/frontend/theme/White/images/loader.gif" />');	 			
				},
				success: function(data){	
					$('#result').hide();
	...
	**/
	$('#frmteammoreinfo').on('submit', function(e){
        ...
        $.ajax({
            ...
            beforeSend: function(){
			    $('#teammoreresult').show();
                $('#teammoreresult').html('<img src="/wp-content/plugins/skopes/frontend/theme/White/images/loader.gif" />');				
            },
            success: function(data){
