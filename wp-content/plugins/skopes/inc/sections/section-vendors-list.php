<?php
	...
	class skope_vendor_list extends WP_List_Table {
		...
		private function get_sql_results() {
			...
			foreach ( $sql_results as $k => $sql_result ) {
				...
				$paymentLink = admin_url('admin.php?action=payments&page=users-and-payments&tab=vendor&user_id='.$sql_result->ID);
				$paymentTitle = 'View payment details';

				$deleteLink = admin_url('admin.php?action=delete&page=users-and-payments&tab=vendor&user_id='.$sql_result->ID);
			...
			$sql_results = array_values($sql_results);
            return $sql_results;
        }
