...
$docx = new CreateDocx();
$newdocx = new getdocx();
$template_filename = 'RFQ_Response_template'; // template name
$result_filename = 'RFQ_Response_result'; // output file name
...
$downloadFileName = base64_encode('RFQ_Response.docx');
