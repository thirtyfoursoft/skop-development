...
<div class="pop-block" id="popContent_1" style="display:none;">
  ...
  <div class="pop-box">
    ...
    <div class="box-row2">
      ...
      <a href="##" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
    </div>
  </div>
</div>
...
<div class="pop-block" id="popContent_3" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 46%; width:auto;  top:10%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help3.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_4" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 46%; width:auto;  top:10%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help4.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_6" style="display:none;">
  ...
  <div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help6.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_7" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 28%; width:auto;  top:5%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help7.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_9" style="display:none;">
  ...
  <div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help9.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_12" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 35%; width:auto; top:10%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help12.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_14" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 35%; width:auto; top:10%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help14.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_16" style="display:none;">
  ...
  <!--<div class="pop-box" style="left: 29%; width:auto; top:8%;">-->
	<div class="pop-box">
    <div class="box-row1">
    <p><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/help16.png"></p>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
      <a href="#" class="help-screen-but" id="popNext"><strong>Next</strong> help screen <img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/right-arrow1.png" alt=""></a>
...
<div class="pop-block" id="popContent_17" style="display:none;">
  ...
  <div class="pop-box">
    <div class="box-row1 co-box">
      ...
      <ul class="pop-list1">
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_1.png" alt=""> Answering all questions in My Organisation</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_1.png" alt=""> Answering all questions in Project Basics</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_1.png" alt=""> Incluing and excluding all functional areas</li>
      </ul>
      <p>You can now download the Project Initiatio Documents:</p>
      <ul class="pop-list1">
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Project Introduction and Rationale</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Expression of Interest</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Expression of Interest Response</li>
      </ul>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
...
<div class="pop-block" id="popContent_21" style="display:none;">
  ...
  <div class="pop-box">
    <div class="box-row1 co-box">
      ...
      <ul class="pop-list1">
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_1.png" alt=""> Answering all questions in Project Details</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_1.png" alt=""> Specifying all features within required functional areas</li>
      </ul>
      <p>You can now download the Vendor Engagement and Project Management Documents:</p>
      <ul class="pop-list1">
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Project Carter & Scope of Work</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Request for Quotation</li>
        <li><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help/bullet_2.png" alt=""> Request for Quotation Respose</li>
      </ul>
    </div>
    <div class="box-row2">
      <a href="#" class="get-started-but" id="closePop"><strong>Dismiss</strong> help and get started</a>
