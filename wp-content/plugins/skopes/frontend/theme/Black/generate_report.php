...
if($userCompanyQues < $totalCompanyQues) {
     if($messageInHeader == "") {
	...
	<div class="content-section darkbox clearfix rp">
		...
		<div class="box_white marbtm30">
			...
			<?php
				...
				if( ($stage == "two") && ( $aboutprojectStatus == 0 ) ) {
			...
			<div class="pi-right">
			    <?php  if( ($stage == "two") && ( $aboutprojectStatus == 0 ) ) { ?>
		...
		<?php
			...
			if($stage == "one" && $AbtYurOrgStatus == "InProgress" ) {
				if($messageInHeaderSecSect == "") {
		...
		<div class="box_white marbtm30">
			...
			<div class="pi-right">
				<?php
					...
					if ( ($getMoreInfoStatus == 0) && ( $stage == 'two' ) && ($total >= $totalFA) && ($userProjectMore >= $compareMoreInfoNo) ) { ?>
			...
			<div class="pi-right">
				<?php	if ( ($getMoreInfoStatus == 0) && ( $stage == 'two' ) && ($total >= $totalFA) && ($userProjectMore >= $compareMoreInfoNo) ) { ?>
