...
<? /*
			<input type="text" value="<?php echo $shval;?>" id="stackholder_<?=$shak+1;?>" name="stackholder[]" class="stackholders" maxlength="12">						
			<span id="error_stackholder_<?=$shak+1;?>" class="error"></span>
