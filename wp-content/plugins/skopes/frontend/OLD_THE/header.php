...
<link href="<?php echo RC_TC_PLUGIN_URL ?>frontend/css/helpPopup.css" rel="stylesheet" media="screen" />
<?php 
		...
		if ( is_user_logged_in() ) {
			if(get_user_meta($loggedin_id,'userprofile',true)==1 || !is_front_page()) { ?>
				...
				<div class="bottom-header" style="display:none;">
					<div class="container">
						<ul class="top-nav">
							<li class="firstHome"><a href="<?php echo home_url().'?act=guide'; ?>"><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/newHome/Homeicon.png" alt=""  style="width: 20px;">
