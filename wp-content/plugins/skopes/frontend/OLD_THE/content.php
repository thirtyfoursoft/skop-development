...
<div class="popup_overlay"></div>
	<div class="popup-section registration" id="popup">
		...
		<div class="loader"><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/loader.gif" alt="" /></div>
	...
	<!--script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/js/jquery.tinyscrollbar.min.js"></script-->
