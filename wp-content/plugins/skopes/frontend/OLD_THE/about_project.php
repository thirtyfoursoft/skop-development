<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/js/jquery-ui.js"></script>
...
<link href="<?php echo RC_TC_PLUGIN_URL ?>frontend/css/jquery-ui.css" rel="stylesheet" media="screen" />
<script>
	$(function() {
					...
					<div class="upf-table l1" id="projectmain"> 
						...
						?>
						  ...
						  <div class="upf-raw">
							...
							<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help-text.png"><?php echo stripslashes($pro_ques3->help_text);?></div> 
						 </div>
						<?php
							}
						...
						?>
								...
								<div class="upf-raw">
									...
									<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help-text.png"><?php echo stripslashes($pro_ques4->help_text);?></div>
								</div>
						<?php
							}
...
*/ ?>
			...
			<div id="proquesstakeholdertext" class="help-text" style="display:none; width: 96%; margin: 0 0 10px 0; font-family: 'Lato', sans-serif;">
				<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help-text.png" style="right: 50%;">
				...
				<div class="accordian-inner">
					<div class="">
						...
						<div id="keyDatestext" class="help-text" style="display:none; width: 96%; margin: 0 0 10px 0; font-family: 'Lato', sans-serif;">
							<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL; ?>frontend/images/help-text.png" style="right: 50%;"><?php echo stripslashes(trim(get_option("help_keysDateText"))); ?>
						</div>
...
<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/js/userproject.js"></script>
...
//		 	form.submit();
		    $.ajax({
		        ...
		        beforeSend: function() {
					$('#riskResult').show('');
		            $('#riskResult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif">');				
		        },
	...
	function removeRiskBlock( blockName ,blockID ) {
		if (blockID > 0) {
			...
			if (r == true) {
				$.ajax({
					type: 'POST',
					url: '/wp-content/plugins/skopes/frontend/my_ajax_functions.php',
