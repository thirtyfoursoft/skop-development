													...
													<div class="sq-cols3">
														<div class="listmain" id="row_<?php echo $linedata[LINEITEM_ID];?>">
															<div class="listraw clearfix row1"  id="row1_<?php echo $linedata[LINEITEM_ID];?>">
																<div class="lr-cols1">Estimate cost savings</div>
																<?php
																	$yescls="";
																	$nocls="";
	...
	<a class="benefit_yes yes-static <?php echo $bycls;?>" href="#" id="benefit_yes_<?php echo $linedata[LINEITEM_ID];?>" lineid="<?php echo $linedata[LINEITEM_ID];?>"></a>
											...
											?>
															...
															<div class="listraw clearfix<?php if($linedata[LINEITEM_IS_AUTOMATED]==1) { ?> row2<?php } ?>"  id="row2_<?php echo $linedata[LINEITEM_ID];?>"  <?php if($linedata[LINEITEM_IS_AUTOMATED]==0) { echo "style='display:none;'"; } ?>>
																...
																<div class="lr-cols2"><input type="text" class="lr-textbox" name="lineitem_year" id="lineitem_year_<?php echo $linedata[LINEITEM_ID]; ?>" value="<?php echo $linedata[LINEITEM_YEAR];?>" onKeyup="floatOnly(this);" onKeydown="floatOnly(this);" onKeypress="floatOnly(this);" /></div>
...
?>
	...
	<div class="listraw-yellow clearfix<?php if($linedata[LINEITEM_INVESTMENT_REQ]!=1 || $linedata[LINEITEM_IS_AUTOMATED]==1) { ?> row4<?php } ?>"  id="row4_<?php echo $linedata[LINEITEM_ID];?>" >
																...
																<div class="lr-cols2"><input type="text" placeholder="$" value="<?php echo $linedata[LINEITEM_COST]; ?>" class="lr-textbox cost_input" name="lineitem_cost" onKeyup="floatOnly(this);" onKeydown="floatOnly(this);" onKeypress="floatOnly(this);" id="lineitem_cost_<?php echo $linedata[LINEITEM_ID]; ?>"     lineid="<?php echo $linedata[LINEITEM_ID];?>" <?php echo $cost_readonly;?> /></div>
...
<input type="text" placeholder="hrs" value="<?php echo $linedata[LINEITEM_TIME]; ?>" class="lr-textbox time_input" name="lineitem_time" id="lineitem_time_<?php echo $linedata[LINEITEM_ID]; ?>" onKeyup="floatOnly(this);" onKeydown="floatOnly(this);" onKeypress="floatOnly(this);"  lineid="<?php echo $linedata[LINEITEM_ID];?>"  <?php echo $time_readonly;?>/></div>
															</div>
