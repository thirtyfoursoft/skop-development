...
{ 
	...
	if(imptotal > 100 ){ 
	   ...
	   //return false; 
		...
		$.ajax({ 
				type: "POST",
				url: "/wp-content/plugins/skopes/frontend/compltechk.php", 
				...
				beforeSend: function(){
					$('#result').show();
					$('#result').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif" />');	 			
				},
...
<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/js/moreprojectinfo.js"></script>
		 ...
		 submitHandler: function(form) {
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#complteRiskManagementMoreInfoResult').html('<img src="/wp-content/plugins/skopes/frontend/images/loader.gif">');				
				},
				success: function(data) {
