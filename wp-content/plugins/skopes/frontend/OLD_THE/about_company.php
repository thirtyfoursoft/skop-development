					...
					<div id="dialog" ></div>
						...
						<?php $upload_dir = wp_upload_dir(); ?>
								...
								<div class="upf-raw">
									...
									<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help-text.png"><?php echo stripslashes($compLogo->help_text);?></div>
								</div>
						<?php
						...
						?>
							<div class="upf-raw">
								...
								<div id="cahelptext" class="help-text" style="display:none;"> <img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/images/help-text.png"><?php echo stripslashes($comp_ques2->help_text);?></div>
							</div>
						<?php
							}
						...
						<?php
							...
							?>
									...
									?>
											...
											<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/js/usercompany.js"></script>
