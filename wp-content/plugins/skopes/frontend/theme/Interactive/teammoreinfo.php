	...
	<div class="tldetails">
		...
		<div class="form-three-colum">
			...
			<div class="second-colum">
				<input type="text" value="<?php echo $tmemberResponsiblity; ?>" id="teamleadresp" name="teamleadresp" class="input-text">
				<span id="error_teamleadresp" class="error"></span>			
			  </div>
			<div class="third-colum">
				<input type="text" value="<?php echo $tmemberEffort;?>" id="teamlead_effort" name="teamlead_effort" class="input-text">
