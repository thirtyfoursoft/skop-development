	...
	$profinalval = $obj->selectProjectQuesStatus($loggedin_id);
						...
						?>
								<div class="form-two-colum">
									...
									if($getAuthor==''){
									?>
										<input type="text" class="input-text" value="<?php echo the_author_meta( 'first_name', $current_user->ID );echo ('&nbsp;');echo the_author_meta( 'last_name', $current_user->ID );?>" name="authors" id="authors" /> 
										 
									<?php } else { ?>	
										<input type="text" class="input-text" value="<?php echo $getAuthor;?>" name="authors" id="authors" />
									<?php } ?>
						...
						<?php 
						   ...
						   $pro_ques5 = $objUser->getDefaultFieldData('project_question5');
							...
							<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques5",true)?>" id="pro_ques5" name="pro_ques5" />
						...
						?>
								<div class="form-two-colum">
									...
									<div class="second-colum">
										...
										<textarea name="pro_ques2" id="pro_ques2" cols="10" rows="5" class="input-textarea"><?php echo htmlspecialchars(stripslashes(get_user_meta($loggedin_id,"pro_ques2",true))); ?></textarea>
						  ...
						  <div class="form-two-colum">
							...
							<div class="second-colum">
								...
								<!--<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques3",true)?>" id="pro_ques3" name="pro_ques3" />-->
							...
							<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/help-text.png">
								<?php echo $pro_ques3->help_text;?></div> 
						 </div>
						<?php
							}
						...
						?>
								...
								<div class="form-two-colum">
									...
									<div class="second-colum">
										<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques4",true)?>" id="pro_ques4" name="pro_ques4" />
									...
									<img class="help-text-img" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/help-text.png"><?php echo $pro_ques4->help_text;?></div>
								</div>
						<?php
							} 
						...
						?>
							<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques6",true)?>" id="pro_ques6" name="pro_ques6" />
						...
						?>
							<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques7",true)?>" id="pro_ques7" name="pro_ques7" />
						...
						?>
							<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques8",true)?>" id="pro_ques8" name="pro_ques8" />
						...
						?>
							<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"pro_ques9",true)?>" id="pro_ques9" name="pro_ques9" />
						...
						<div class="form-two-colum">
								...
								<div class="second-colum">
									<input type="text" class="input-text" value="<?php echo get_user_meta($loggedin_id,"proques10",true)?>" id="proques10" name="proques10" />
