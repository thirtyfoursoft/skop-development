 <?php
	...
	*/
	...
	/* *********** if URL get doLogin then system will logout the current user & do login as new user *********** */
	
	if( isset($_GET["doLogin"]) && $_GET["doLogin"] != "" ) {

		$data = unserialize(base64_decode($_GET["doLogin"]));

		if ( $data['username'] != '' ) {
			if(programmatic_login( $data['username'] ) === true) {
			
				wp_redirect(get_site_url().'?act=guide');					
				exit;
				
			} else {
			
				wp_redirect(get_site_url().'?act=login');					
				exit;
			}
		}
		...
		if(isset($_REQUEST["act"]))
		{
		  ...
		  $i = $_REQUEST["act"];
			...
			case "project_pinch":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/project_pinch.php");
				break;
			case "eoi":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/EOI_Report.php");
				break;
			case "eoi_response":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/EOI_Response.php");
				break;
			case "project_detail":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/project_detail.php");
				break;
			case "rfq":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/RFQ.php");
				break;
			case "rfq_response":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/RFQ_Response.php");
				break;
			case "project_pinchpdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/project_pinchpdf.php");
				break;
			case "eoipdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/eoipdf.php");			
				break;
			...
			case "eoi_responsepdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/eoi_responsepdf.php");			
				break;
			...
			case "project_detailpdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/project_detailpdf.php");			
				break;
			...
			case "rfq_pdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/rfq_pdf.php");
				break;
			case "rfq_responsepdf":
				...
				include(RC_TC_BASE_DIR."/frontend/wordtemplate/files/codefiles/rfq_responsepdf.php");
				break;
...
<head>
	...
	<link href="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/css/selectbox.css" rel="stylesheet" media="screen" />
	...
	<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/jquery-1.11.0.js"></script>
	<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/jquery-migrate-1.2.1.js"></script>
	
	<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/custom.js"></script>
	<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/custom1.js"></script>
	...
	<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/selectbox.js"></script>
	...
	<?php if( isset($_REQUEST['act']) and $_REQUEST['act'] == 'features' ) { ?>
	    <script src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/jquery.confirm.js"></script>
...
<body <?php body_class( $class ); ?> id="<?=$id; ?>">
	<input type="hidden" id="path" value="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>"/>
...
<?php	} 	?>
		...
		<div class="loader" style="display:none;"><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/loader.gif" alt="" /></div>
		<div class="popup_loader" style="display:none;"><img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/loader.gif" alt="" /></div>
		...
		<?php
			$allUrls = array(
				...
				'eoi_result'	=> 'eoi_result.php',
				'featuresNew'  => 'featuresNew.php'
			);
	...
	<?php	if(is_user_logged_in()) {	?>
		...
		<script type="text/javascript" src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/js/login_check.js"></script>
