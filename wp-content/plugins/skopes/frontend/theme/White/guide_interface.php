		...
		*/
		...
		?>
			<div class="presnetej two-presnetej">
				...
				<div class="presnetej-cont">
					<div class="select-number" style="background-position:100% <?php echo $backgroundPostion; ?>%">
							<!--<img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/newHome/2-img.png" alt="" />-->
	...
	?>
		<div class="guide-column">
			<div class="presnetej">
				...
				<!--<img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/newHome/three-img.png" alt="" />-->
	...
	?>
		<div class="guide-column guide-four">
			<div class="presnetej">
				...
				<!--<img src="<?php echo RC_TC_PLUGIN_URL ?>frontend/theme/<?=$choosenTheme; ?>/images/newHome/four-img.png" alt="" />-->
			</div>
